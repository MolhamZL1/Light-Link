...
public class Levels {
    ...
    State initGridLevel1() {
        Light light1 = new Light(Directions.Bottom, 10, 3);
        Target target1 = new Target( 4, 3);
        Wall wall1 = new Wall(4, 2);
        Wall wall2 = new Wall(5, 2);
        Wall wall3 = new Wall(6, 2);
        Wall wall4 = new Wall(7, 2);
        Wall wall5 = new Wall(8, 2);
        Wall wall6 = new Wall(9, 2);
        Wall wall7 = new Wall(10, 2);
         Wall wall8 = new Wall(7, 3);
        Wall[] walls = {wall1, wall2, wall3, wall5, wall4, wall6,wall7,wall8};
        RotatedMirror mirror1 = new RotatedMirror(MirrorDirections.horizintal,7, 6);
